    ...
    return (
        <div className="flex flex-col w-full h-[150px] p-10">
            ...
            <div className="flex flex-row w-full h-[100px] items-center justify-between">
                <h1 className='text-black text-3xl font-extrabold flex-shrink-0'> Brixely </h1>
                ...
                <a href="https://example.com" target="_blank" rel="noopener noreferrer" className="flex-shrink-0">
